...
class Lamp4 extends Component {
    ...
    componentDidMount() {
        const status = firebase.database().ref('lampadas/lamp4').child('controle');
    ...
    botaoDesligar (){
        const controle = firebase.database().ref('lampadas/lamp4');
    ...
    if (this.state.status === 1 ) {
        return (
            <Card style={{ backgroundColor: '#ffbb00', marginTop: 10, marginBotton: 10, textAlign:'center'}}  onClick={this.botaoDesligar}>
                <CardContent>
                    <h1 style={{marginTop: 5, fontSize: 20, textAlign: 'center', color: '#fff'}}>4</h1>   
            ...
            return (
                <Card style={{ backgroundColor: '#eee', marginTop: 10, marginBotton: 10, textAlign:'center'}}  onClick={this.botaoLigar}>
                    <CardContent>
                        <h1 style={{marginTop: 5, fontSize: 20, textAlign: 'center'}}>4</h1>
