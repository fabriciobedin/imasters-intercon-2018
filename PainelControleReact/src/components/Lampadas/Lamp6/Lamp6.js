...
class Lamp6 extends Component {
    ...
    componentDidMount() {
        const status = firebase.database().ref('lampadas/lamp6').child('controle');
    ...
    botaoDesligar (){
        const controle = firebase.database().ref('lampadas/lamp6');
    ...
    if (this.state.status === 1 ) {
        return (
            <Card style={{ backgroundColor: '#00e012', marginTop: 10, marginBotton: 10, textAlign:'center'}}  onClick={this.botaoDesligar}>
                <CardContent>
                    <h1 style={{marginTop: 5, fontSize: 20, textAlign: 'center', color: '#fff'}}>6</h1>   
            ...
            return (
                <Card style={{ backgroundColor: '#eee', marginTop: 10, marginBotton: 10, textAlign:'center'}}  onClick={this.botaoLigar}>
                    <CardContent>
                        <h1 style={{marginTop: 5, fontSize: 20, textAlign: 'center'}}>6</h1>
