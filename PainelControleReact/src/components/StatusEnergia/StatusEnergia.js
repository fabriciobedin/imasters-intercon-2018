    ...
    if (this.state.statusServidor == 1 ) {
      return (
        <div style={{display: 'inline-block', lineHeight: '10px'}}>
          ...
          <h2 style={{marginLeft: '10px', float: "right", color: '#777'}}> OK</h2>
        </div>
      );
      ...
      return (
        <div style={{display: 'inline-block', lineHeight: '10px'}}>
          ...
          <h2 style={{marginLeft: '10px', float: "right", color: '#777'}}> Sem luz</h2>
        </div>
      );
    } else{
      return(
  ...
  render() {
    return (
      <Card style={{ backgroundColor: '#eee', marginTop: 20, textAlign:'center'}}>
        <CardContent>
            <h1 style={{marginTop: 5, fontSize: 20, textAlign: 'center'}}>Status Energia </h1>
